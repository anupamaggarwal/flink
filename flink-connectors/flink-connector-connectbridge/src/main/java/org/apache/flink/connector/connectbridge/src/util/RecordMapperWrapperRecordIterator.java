...
package org.apache.flink.connector.connectbridge.src.util;
...
/**
 * Implementation of {@link org.apache.flink.connector.connectbridge.src.reader.BulkFormat.RecordIterator}
 * that wraps another iterator and performs the mapping of the records. You can use {@link
 * #wrapReader(org.apache.flink.connector.connectbridge.src.reader.BulkFormat.Reader, RecordMapper)} to wrap a whole reader.
 *
 * @param <I> Input type
