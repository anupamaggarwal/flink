...
import org.apache.flink.connector.connectbridge.src.assigners.FileSplitAssigner;
import org.apache.flink.connector.connectbridge.src.assigners.LocalityAwareSplitAssigner;
import org.apache.flink.connector.connectbridge.src.enumerate.BlockSplittingRecursiveEnumerator;
import org.apache.flink.connector.connectbridge.src.enumerate.FileEnumerator;
import org.apache.flink.connector.connectbridge.src.enumerate.NonSplittingRecursiveEnumerator;
import org.apache.flink.connector.connectbridge.src.reader.BulkFormat;
import org.apache.flink.connector.connectbridge.src.reader.FileRecordFormat;
import org.apache.flink.connector.connectbridge.src.reader.StreamFormat;
import org.apache.flink.connector.connectbridge.src.impl.FileRecordFormatAdapter;
import org.apache.flink.connector.connectbridge.src.impl.StreamFormatAdapter;
 ...
 *
 * <ul>
 *   <li>{@link FileSource#forRecordStreamFormat(org.apache.flink.connector.connectbridge.src.reader.StreamFormat, Path...)}
 *   <li>{@link FileSource#forBulkFileFormat(org.apache.flink.connector.connectbridge.src.reader.BulkFormat, Path...)}
 * </ul>
 *
 ...
 *
 * <ul>
 *   <li>A {@link org.apache.flink.connector.connectbridge.src.reader.StreamFormat} reads the contents of a file from a file stream. It is the simplest
 ...
 *   <li>A {@link org.apache.flink.connector.connectbridge.src.reader.BulkFormat} reads batches of records from a file at a time. It is the most "low
 ...
 * org.apache.flink.connector.connectbridge.src.enumerate.FileEnumerator}. The {@code FileEnumerator} is responsible to select the relevant files (for
...
public final class FileSource<T> extends AbstractFileSource<T, FileSourceSplit> {
    ...
    /**
     * Builds a new {@code FileSource} using a {@link org.apache.flink.connector.connectbridge.src.reader.StreamFormat} to read record-by-record from a
     * file stream.
     *
    ...
    /**
     * Builds a new {@code FileSource} using a {@link org.apache.flink.connector.connectbridge.src.reader.FileRecordFormat} to read record-by-record
     * from a a file path.
     *
