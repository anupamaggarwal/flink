...
package org.apache.flink.connector.connectbridge.src.reader;
...
import org.apache.flink.connector.connectbridge.src.util.MutableRecordAndPosition;
...
public interface BulkFormat<T, SplitT extends FileSourceSplit>
    ...
    interface Reader<T> extends Closeable {
         ...
         * org.apache.flink.connector.connectbridge.src.util.Pool} and recycle objects into the Pool in the
